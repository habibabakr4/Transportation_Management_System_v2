...
RSpec.describe "TrucksController", type: :request do
  ...
  describe "GET /my_trucks" do
    let!(:assignment1) { Assignment.create(driver: driver, truck: truck1, assignment_date: Time.now) }
    let!(:assignment2) { Assignment.create(driver: driver, truck: truck2, assignment_date: Time.now) }
